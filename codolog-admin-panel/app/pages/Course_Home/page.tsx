            ...
            >
              ...
              <td className="px-4 py-3 border-b border-gray-50">
                <div className="flex items-center gap-1.5">
                  <button
                    onClick={() => router.push(`/pages/Course_Home/edit/${course.id}`)}
...
function SchedulingPanel() {
  ...
  const [schedules, setSchedules] = useState([
    {
      ...
      time: "",
      tutor: "Priya Singh",
      link: "https://meet.google.com/aaa-bbbb",
    },
  ]);
  ...
  const addSchedule = () => {
    setSchedules([
      ...
      {
        id: Date.now(),
        module: `Module ${schedules.length + 1}`,
        topic: "",
        date: "",
        time: "",
        tutor: "Priya Singh",
  ...
  return (
    <div className="bg-white rounded-2xl p-8 border border-gray-200">
      ...
      {schedules.map((schedule) => (
        <div
          key={schedule.id}
          className="bg-gray-50 rounded-2xl p-6 mb-6 border"
        >
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input
                value={getDayFromDate(schedule.date)}
                readOnly
                className="w-full border rounded-xl p-3 text-black bg-gray-100"
              />
            </div>
