...
const AddCoursePage: React.FC = () => {
  ...
  className={`bg-transparent border-b-2 text-lg text-black font-bold outline-none pb-2 w-full mr-4 ${
    !mod.name && error
      ? 'border-red-300'
      : 'border-slate-300 focus:border-fuchsia-600'
  }`}
  value={mod.name}
  onChange={(e) =>
    setModules(
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
  ...
  <input
    type="text"
    placeholder="Live Session Link"
    className="border border-slate-300 p-3 rounded-xl text-black"
  />
